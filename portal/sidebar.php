<div id="sidebar" class="bg-blue-600 text-white w-64 transition-width duration-300 min-h-screen flex flex-col sidebar-expanded">
    ...
    <nav class="flex-1 flex flex-col space-y-4 mt-4 p-4">
      <a href="homepage.php" data-content="dashboard" class="flex items-center space-x-4 p-2 hover:bg-blue-700 rounded">
      ...
      <div class="relative">
        ...
        <div id="reportsDropdownContent" class="ml-10 text-gray-200 hidden">
          ...
          <a href="report.php" data-content="report" class="sidebar-text block p-2 hover:bg-blue-700 rounded content-link">Reports Form</a>
        </div>
      </div>
    
      <a href="register.php" data-content="registration" class="flex items-center space-x-4 p-2 hover:bg-blue-700 rounded content-link">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <a href="contact.php" data-content="registration" class="flex items-center space-x-4 p-2 hover:bg-blue-700 rounded ">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3" />
        </svg>
        <span class="sidebar-text">Contact</span>
      </a>
      <a href="about.php" data-content="" class="flex items-center space-x-4 p-2 hover:bg-blue-700 rounded content-link">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3" />
        </svg>
